...
echo "set datafile separator '|';set term eps; set output 'q4-2.eps'; set xlabel 'out degree'; set ylabel 'frequency'; plot 'distribution.txt'; " | gnuplot

# Note for Q4-4 there is no code to run.  Just include your answer
echo "For Q4.4, there is an unusual number of nodes with out degree 46"
...
time sqlite3 patents.db < q7.sql

# If this takes over an hour for you, fill in the following answers:
echo "Q4.7.a: The following statements are true: 1"
